    ...
    with col1:
        if st.button("이전 단계(주호소 질문으로)"):
            for key in list(st.session_state.keys()):
                if any(s in key for s in ["jaw_", "pain_", "frequency", "time_", "headache"]):
                    st.session_state.pop(key, None)
            st.session_state.step = 2
            st.rerun()
...
def render_step_13_neck_shoulder():
    ...
    with st.container(border=True):
        ...
        st.checkbox(
            ...
            key="neck_pain",
            on_change=update_neck_symptom, args=("neck_pain",),
        ...
        st.checkbox(
            ...
            key="shoulder_pain",
            on_change=update_neck_symptom, args=("shoulder_pain",),
            disabled=st.session_state.get("neck_none", False)
        )
        ...
        st.checkbox(
            ...
            key="stiffness",
            on_change=update_neck_symptom, args=("stiffness",),
            disabled=st.session_state.get("neck_none", False)
        )
    ...
    with st.container(border=True):
        ...
        st.radio(
            ...
            on_change=sync_widget_key, args=("neck_trauma_radio_widget", "neck_trauma_radio"),
            label_visibility="collapsed"
        )
...
def render_step_14_stress_history():
    ...
    with st.container(border=True):
        ...
        st.radio(
            ...
            on_change=sync_widget_key, args=("stress_radio_widget", "stress_radio"),
            label_visibility="collapsed"
        )
        ...
        st.text_area(
            ...
            on_change=sync_widget_key, args=("stress_detail_widget", "stress_detail"),
...
def render_step_15_past_dental_history():
    ...
    with st.container(border=True):
        ...
        st.radio(
            ...
            on_change=sync_widget_key, args=("ortho_exp_widget", "ortho_exp"),
            label_visibility="collapsed"
        )
        st.text_input(
            ...
            on_change=sync_widget_key, args=("ortho_detail_widget", "ortho_detail")
        )
        ...
        st.radio(
            ...
            on_change=sync_widget_key, args=("prosth_exp_widget", "prosth_exp"),
            label_visibility="collapsed"
        )
        st.text_input(
            "예라면 어떤 치료였는지 적어주세요:",
            ...
            on_change=sync_widget_key, args=("prosth_detail_widget", "prosth_detail")
        )
        ...
        st.text_area(
            ...
            on_change=sync_widget_key, args=("other_dental_widget", "other_dental"),
            label_visibility="collapsed"
        )
        ...
        st.radio(
            ...
            on_change=sync_widget_key, args=("tmd_treatment_history_widget", "tmd_treatment_history"),
            label_visibility="collapsed"
        )
        if st.session_state.get("tmd_treatment_history") == "예":
            st.text_input(
                ...
                on_change=sync_widget_key, args=("tmd_treatment_detail_widget", "tmd_treatment_detail")
            )
            st.text_input(
                "해당 치료에 대한 반응(효과나 문제점 등):",
                key="tmd_treatment_response_widget",
                value=st.session_state.get("tmd_treatment_response", ""),
                on_change=sync_widget_key, args=("tmd_treatment_response_widget", "tmd_treatment_response")
            )
            st.text_input(
                "현재 복용 중인 턱관절 관련 약물이 있다면 입력해주세요:",
                key="tmd_current_medications_widget",
                value=st.session_state.get("tmd_current_medications", ""),
                on_change=sync_widget_key, args=("tmd_current_medications_widget", "tmd_current_medications")
            )
        else:
...
def render_step_16_past_medical_history():
    ...
    with st.container(border=True):
        ...
        st.text_area(
            ...
            on_change=sync_widget_key, args=("past_history_widget", "past_history"),
            label_visibility="collapsed"
        )
        ...
        st.text_area(
            ...
            on_change=sync_widget_key, args=("current_medications_widget", "current_medications"),
            label_visibility="collapsed"
        )
...
def render_step_17_provocation_tests():
    ...
    with st.container(border=True):
        ...
        st.radio(
            ...
            on_change=sync_widget_key, args=("bite_right_widget", "bite_right"),
            label_visibility="collapsed"
        )
        ...
        st.radio(
            ...
            on_change=sync_widget_key, args=("bite_left_widget", "bite_left"),
            label_visibility="collapsed"
        )
        ...
        st.radio(
            ...
            on_change=sync_widget_key, args=("loading_test_widget", "loading_test"),
            label_visibility="collapsed"
        )
        ...
        st.radio(
            ...
            on_change=sync_widget_key, args=("resistance_test_widget", "resistance_test"),
            label_visibility="collapsed"
        )
        ...
        st.radio(
            ...
            on_change=sync_widget_key, args=("attrition_widget", "attrition"),
            label_visibility="collapsed"
        )
...
def render_step_18_functional_impact():
    ...
    with st.container(border=True):
        ...
        st.radio(
            ...
            key="impact_daily",
            on_change=sync_widget_key, args=("impact_daily", "impact_daily"),
            label_visibility="collapsed"
        )
        ...
        st.radio(
            ...
            key="impact_work",
            on_change=sync_widget_key, args=("impact_work", "impact_work"),
            label_visibility="collapsed"
        )
        ...
        st.radio(
            ...
            on_change=sync_widget_key, args=("impact_quality_of_life", "impact_quality_of_life"),
            label_visibility="collapsed"
        )
        ...
        st.radio(
            ...
            key="sleep_quality",
            on_change=sync_widget_key, args=("sleep_quality", "sleep_quality"),
            label_visibility="collapsed"
        )
        ...
        st.radio(
            ...
            on_change=sync_widget_key, args=("sleep_tmd_relation", "sleep_tmd_relation"),
            label_visibility="collapsed"
        )
