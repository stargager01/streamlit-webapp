...
def render_step_4_pain_classification():
    ...
    with st.container(border=True):
        ...
        if pain_type in ["넓은 부위의 통증", "근육 통증"]:
            ...
            st.radio(
                ...
                yes_no_options,
                index=get_radio_index("muscle_movement_pain_value"),
            ...
            st.radio(
                ...
                yes_no_options,
                index=get_radio_index("muscle_pressure_2s_value"),
            ...
            if st.session_state.muscle_pressure_2s_value == "예":
                st.radio(
                    ...
                    yes_no_options,
                    index=get_radio_index("muscle_referred_pain_value"),
                ...
                if st.session_state.muscle_referred_pain_value == "예":
                    st.radio(
                        ...
                        yes_no_options,
                        index=get_radio_index("muscle_referred_remote_pain_value"),
            ...
            st.radio(
                ...
                yes_no_options,
                index=get_radio_index("tmj_movement_pain_value"),
            ...
            st.radio(
                ...
                yes_no_options,
                index=get_radio_index("tmj_press_pain_value"),
            ...
            st.radio(
                "두통이 관자놀이 부위에서 발생하나요?",
                yes_no_options,
                index=get_radio_index("headache_temples_value"),
            ...
            st.radio(
                ...
                yes_no_options,
                index=get_radio_index("headache_reproduce_by_pressure_value"),
            ...
            st.radio(
                "턱을 움직일 때 두통이 심해지나요?",
                yes_no_options,
                index=get_radio_index("headache_with_jaw_value"),
            ...
            if st.session_state.headache_with_jaw_value == "예":
                st.radio(
                    ...
                    yes_no_options,
                    index=get_radio_index("headache_not_elsewhere_value"),
    ...
    def validate_pain_classification():
        ...
        if pt in ["넓은 부위의 통증", "근육 통증"]:
            ...
            if st.session_state.muscle_pressure_2s_value == "예":
                ...
                if st.session_state.muscle_referred_pain_value == "예" and st.session_state.muscle_referred_remote_pain_value == "선택 안 함":
    ...
    create_navigation_buttons(prev_step=3, next_step=6, validation_func=validate_pain_classification)
...
def render_step_5_tmj_sounds_locking():
    ...
    with st.container(border=True):
        ...
        if st.session_state.get("tmj_sound_value") == "딸깍소리":
            st.markdown("**딸깍소리가 언제 발생하나요? (복수 선택 가능)**")
            st.multiselect(
                label="",
                options=["입 벌릴 때", "입 다물 때", "입 벌릴 때와 다물 때 모두", "기타"],
        ...
        if st.session_state.get("tmj_sound_value") == "사각사각소리(크레피투스)":
            st.markdown("**사각사각소리가 확실한가요?**")
            st.radio(
                label="",
                options=yes_no_options,
                index=yes_no_options.index(st.session_state.get("crepitus_confirmed_value", "선택 안 함")),
        ...
        if st.session_state.get("crepitus_confirmed_value") == "아니오":
            ...
            st.radio(
                label="",
                options=yes_no_options,
                index=yes_no_options.index(st.session_state.get("jaw_locked_now_value", "선택 안 함")),
            ...
            if st.session_state.get("jaw_locked_now_value") == "예":
                st.markdown("**손으로 조작해서 턱 잠김을 풀 수 있나요?**")
                st.radio(
                    label="",
                    options=yes_no_options,
                    index=yes_no_options.index(st.session_state.get("jaw_unlock_possible_value", "선택 안 함")),
            ...
            if st.session_state.get("jaw_locked_now_value") == "아니오":
                ...
                st.radio(
                    label="",
                    options=yes_no_options,
                    index=yes_no_options.index(st.session_state.get("jaw_locked_past_value", "선택 안 함")),
                ...
                if st.session_state.get("jaw_locked_past_value") == "예":
                    st.markdown("**MAO 검사 시 손가락 3개가 들어가나요?**")
                    st.radio(
                        label="",
                        options=yes_no_options,
                        index=yes_no_options.index(st.session_state.get("mao_fits_3fingers_value", "선택 안 함")),
    ...
    create_navigation_buttons(prev_step=2, next_step=6, validation_func=validate_tmj_sounds)
...
def render_step_6_frequency_timing():
    ...
    with st.container(border=True):
        ...
        frequency_options = ["매일", "주 3~4회", "주 1~2회", "월 1~2회", "거의 없음", "선택 안 함"]
        st.radio(
            label="",
            options=frequency_options,
            index=frequency_options.index(st.session_state.get("frequency_choice", "선택 안 함")),
    ...
    headache_options = ["예", "아니오", "선택 안 함"]
    st.radio(
        label="",
        options=headache_options,
        index=headache_options.index(st.session_state.get("has_headache_now", "선택 안 함")),
    ...
    if st.session_state.get("has_headache_now") == "예":
        ...
        headache_area_options = ["관자놀이", "이마", "뒤통수", "측두부", "기타"]
        st.multiselect(
            label="",
            options=headache_area_options,
        ...
        st.markdown("**두통 빈도**")
        headache_freq_options = ["매일", "주 3~4회", "주 1~2회", "월 1~2회", "거의 없음", "선택 안 함"]
        st.radio(
            label="",
            options=headache_freq_options,
            index=headache_freq_options.index(st.session_state.get("headache_frequency_widget", "선택 안 함")),
    ...
    def validate_frequency_timing():
        ...
        time_selected = any([
            st.session_state.get("time_아침"),
            st.session_state.get("time_오후"),
            st.session_state.get("time_저녁"),
        ])
    ...
    create_navigation_buttons(prev_step=5, next_step=7, validation_func=validate_frequency_timing)
